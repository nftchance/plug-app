...
export const Search: FC<SearchProps> = ({ search, results = 0 }) => {
	...
	return (
		<div
			className={cn(
				"transition-bg group sticky top-12 z-[999] flex w-full flex-row items-center border-b-[1px] border-r-[1px] border-stone-950 bg-stone-900 px-4 duration-200 ease-in-out hover:bg-stone-950",
